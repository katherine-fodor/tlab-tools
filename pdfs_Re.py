...
ax1.set_xlim(-3,3)
ax2.set_xlim(-3,3)
cs1 = ax1.contourf(NS42_s1gradpdf_x_mean,NS42_s1gradpdf_y_mean,NS42_s1gradpdf_interp_runmean,cmap='viridis',levels=np.linspace(0,0.4,9),extend='max')
cs2 = ax2.contourf(S20_42_s1gradpdf_x_mean,S20_42_s1gradpdf_y_mean,S20_s1gradpdf_interp_runmean,cmap='viridis',levels=np.linspace(0,0.4,9),extend='max')
