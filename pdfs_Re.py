...
S0_vortpdf_interp_data = Pdfs([path+'2560x512x2560/stats/pdfs/pdf21000.LnEnstrophyW_iW_i'],path+'2560x512x2560/y.dat')
S05_vortpdf_interp_data = Pdfs([path+'1280x512x1280-S05/stats/pdfs/pdf28000.LnEnstrophyW_iW_i'],path+'1280x512x1280-S05/y.dat')
S10_vortpdf_interp_data = Pdfs([path+'1280x512x1280-S10/stats/pdfs/pdf32000.LnEnstrophyW_iW_i'],path+'1280x512x1280-S10/y.dat')
S15_vortpdf_interp_data = Pdfs([path+'1536x576x1536-S15/stats/pdfs/pdf35000.LnEnstrophyW_iW_i'],path+'1536x576x1536-S15/y.dat')
S20_vortpdf_interp_data = Pdfs([path+'S20-1536x576x1536/stats/pdfs/pdf35000.LnEnstrophyW_iW_i'],path+'S20-1536x576x1536/y.dat')
S25_vortpdf_interp_data = Pdfs([path+'2560x896x2560-S25/stats/pdfs/pdf57000.LnEnstrophyW_iW_i'],path+'2560x896x2560-S25/y.dat')
...
plt.savefig(opath+'pdfs.pdf',bbox_inches='tight')
plt.show()
