...
lapaz_data = np.loadtxt(colourmap_path+'lapaz/lapaz.txt')
...
cs2 = ax2.contourf(NS117_vortpdf_x_mean,NS117_vortpdf_y_mean,NS117_vortpdf_interp_runmean,cmap='viridis',levels=np.linspace(0,0.4,9))
ax2.scatter(maxvort_NS117,NS117.y/np.mean(NS117.z_enc),5,color='k',marker='.')
ax2.scatter((maxvort_NS117[maxit_vort_NS117-1]+maxvort_NS117[maxit_vort_NS117])/2,NS117.y[maxit_vort_NS117]/np.mean(NS117.z_enc),100,color='k',marker='*')
...
cs1 = ax1.contourf(NS25_vortpdf_x_mean,NS25_vortpdf_y_mean,NS25_vortpdf_interp_runmean,cmap='viridis',levels=np.linspace(0,0.4,9))
ax1.scatter(maxvort_NS25,NS25.y/np.mean(NS25.z_enc),5,color='k',marker='.')
...
ax1.scatter(maxvort_NS42,NS42_3.y/np.mean(NS42.z_enc),5,color='k',marker='.')
...
ax2.scatter(maxvort_S20,S20_42.y/np.mean(S20_42.z_enc),5,color='k',marker='.')
