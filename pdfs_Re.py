...
maxvort_avg_S0 = [ running_average( S0.y[j_min:j_max]/np.mean(S0.z_enc), maxvort_S0[j_min:j_max], dy, samplesize ) ]
maxvort_avg_S05 = [ running_average( S05.y[j_min:j_max]/np.mean(S05.z_enc), maxvort_S05[j_min:j_max], dy, samplesize ) ]
maxvort_avg_S10 = [ running_average( S10.y[j_min:j_max]/np.mean(S10.z_enc), maxvort_S10[j_min:j_max], dy, samplesize ) ]
maxvort_avg_S15 = [ running_average( S15.y[j_min:j_max]/np.mean(S15.z_enc), maxvort_S15[j_min:j_max], dy, samplesize ) ]
maxvort_avg_S20 = [ running_average( S20.y[j_min:j_max]/np.mean(S20.z_enc), maxvort_S20[j_min:j_max], dy, samplesize ) ]
maxvort_avg_S25 = [ running_average( S25.y[j_min:j_max]/np.mean(S25.z_enc), maxvort_S25[j_min:j_max], dy, samplesize ) ]
...
ax1.scatter(maxvort_avg_S0[0][1][j_saddle_S0[0]],maxvort_avg_S0[0][0][j_saddle_S0[0]],100,color='k',marker='*')
...
ax2.scatter(maxvort_avg_S05[0][1][j_saddle_S05[0]],maxvort_avg_S05[0][0][j_saddle_S05[0]],100,color='k',marker='*')
...
ax3.scatter(maxvort_avg_S10[0][1][j_saddle_S10[0]],maxvort_avg_S10[0][0][j_saddle_S10[0]],100,color='k',marker='*')
...
ax4.scatter(maxvort_avg_S15[0][1][j_saddle_S15[0]],maxvort_avg_S15[0][0][j_saddle_S15[0]],100,color='k',marker='*')
...
ax5.scatter(maxvort_avg_S20[0][1][j_saddle_S20[0]],maxvort_avg_S20[0][0][j_saddle_S20[0]],100,color='k',marker='*')
...
ax6.scatter(maxvort_avg_S25[0][1][j_saddle_S25[0]],maxvort_avg_S25[0][0][j_saddle_S25[0]],100,color='k',marker='*')
...
plt.savefig(opath+'pdfs_maxgrad_jmax-100.pdf',bbox_inches='tight')
plt.show()
