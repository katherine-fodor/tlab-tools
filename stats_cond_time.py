...
#ax1.axhline(np.mean(S0.z_if[4:7]/S0.z_enc[4:7]),0,0.05,c=blues(0.5))
#ax1.axhline(np.mean(S20_1.z_if[4:]/S20_1.z_enc[4:]),0,0.05,c=blues(0.9))
...
ax3.set_ylabel(r'$(\rho_{bw})_{z_{i,f}}/((\rho_{bw})_{z_{i,f}})_c$')
...
ax4.set_ylim(0,0.4)
ax4.set_xlim(10,30)
ax1.plot(np.mean(S0_vort_int.int2[4:7,:]*(S0_vort_int.P2v1[4:7,:]-S0_vort_int.P2S1Mom1[4:7,:]*S0_vort_int.P2VMom1[4:7,:])/B0,axis=0),S0.y/np.mean(S0.z_enc[4:7]),c=blues(0.5))
ax1.plot(np.mean(S05_vort_int.int2[4:7,:]*(S05_vort_int.P2v1[4:7,:]-S05_vort_int.P2S1Mom1[4:7,:]*S05_vort_int.P2VMom1[4:7,:])/B0,axis=0),S05.y/np.mean(S05.z_enc[4:7]),c=blues(0.6))
ax1.plot(np.mean(S10_vort_int.int2[4:7,:]*(S10_vort_int.P2v1[4:7,:]-S10_vort_int.P2S1Mom1[4:7,:]*S10_vort_int.P2VMom1[4:7,:])/B0,axis=0),S10.y/np.mean(S10.z_enc[4:7]),c=blues(0.7))
ax1.plot(np.mean(S15_vort_int.int2[4:7,:]*(S15_vort_int.P2v1[4:7,:]-S15_vort_int.P2S1Mom1[4:7,:]*S15_vort_int.P2VMom1[4:7,:])/B0,axis=0),S15.y/np.mean(S15.z_enc[4:7]),c=blues(0.8))
ax1.plot(np.mean(S20_vort_int_1.int2[4:,:]*(S20_vort_int_1.P2v1[4:,:]-S20_vort_int_1.P2S1Mom1[4:,:]*S20_vort_int_1.P2VMom1[4:,:])/B0,axis=0),S20_1.y/np.mean(S20_1.z_enc[4:]),c=blues(0.9))
ax1.plot(np.mean(S25_vort_int.int2[4:7,:]*(S25_vort_int.P2v1[4:7,:]-S25_vort_int.P2S1Mom1[4:7,:]*S25_vort_int.P2VMom1[4:7,:])/B0,axis=0),S25.y/np.mean(S25.z_enc[4:7]),c=blues(1.0))
ax1.plot(np.mean(S0_vort_int.int1[4:7,:]*(S0_vort_int.P1v1[4:7,:]-S0_vort_int.P1S1Mom1[4:7,:]*S0_vort_int.P1VMom1[4:7,:])/B0,axis=0),S0.y/np.mean(S0.z_enc[4:7]),c=blues(0.5),ls='--')
ax1.plot(np.mean(S05_vort_int.int1[4:7,:]*(S05_vort_int.P1v1[4:7,:]-S05_vort_int.P1S1Mom1[4:7,:]*S05_vort_int.P1VMom1[4:7,:])/B0,axis=0),S05.y/np.mean(S05.z_enc[4:7]),c=blues(0.6),ls='--')
ax1.plot(np.mean(S10_vort_int.int1[4:7,:]*(S10_vort_int.P1v1[4:7,:]-S10_vort_int.P1S1Mom1[4:7,:]*S10_vort_int.P1VMom1[4:7,:])/B0,axis=0),S10.y/np.mean(S10.z_enc[4:7]),c=blues(0.7),ls='--')
ax1.plot(np.mean(S15_vort_int.int1[4:7,:]*(S15_vort_int.P1v1[4:7,:]-S15_vort_int.P1S1Mom1[4:7,:]*S15_vort_int.P1VMom1[4:7,:])/B0,axis=0),S15.y/np.mean(S15.z_enc[4:7]),c=blues(0.8),ls='--')
ax1.plot(np.mean(S20_vort_int_1.int1[4:,:]*(S20_vort_int_1.P1v1[4:,:]-S20_vort_int_1.P1S1Mom1[4:,:]*S20_vort_int_1.P1VMom1[4:,:])/B0,axis=0),S20_1.y/np.mean(S20_1.z_enc[4:]),c=blues(0.9),ls='--')
ax1.plot(np.mean(S25_vort_int.int1[4:7,:]*(S25_vort_int.P1v1[4:7,:]-S25_vort_int.P1S1Mom1[4:7,:]*S25_vort_int.P1VMom1[4:7,:])/B0,axis=0),S25.y/np.mean(S25.z_enc[4:7]),c=blues(1.0),ls='--')
ax1.plot(np.mean(S0_vort_int.int2[4:7,:]*S0_vort_int.int1[4:7,:]*(S0_vort_int.P2S1Mom1[4:7,:]-S0_vort_int.P1S1Mom1[4:7,:])*(S0_vort_int.P2VMom1[4:7,:]-S0_vort_int.P1VMom1[4:7,:])/B0,axis=0),S0.y/np.mean(S0.z_enc[4:7]),c=blues(0.5),ls='-.')
ax1.plot(np.mean(S05_vort_int.int2[4:7,:]*S05_vort_int.int1[4:7,:]*(S05_vort_int.P2S1Mom1[4:7,:]-S05_vort_int.P1S1Mom1[4:7,:])*(S05_vort_int.P2VMom1[4:7,:]-S05_vort_int.P1VMom1[4:7,:])/B0,axis=0),S05.y/np.mean(S05.z_enc[4:7]),c=blues(0.6),ls='-.')
ax1.plot(np.mean(S10_vort_int.int2[4:7,:]*S10_vort_int.int1[4:7,:]*(S10_vort_int.P2S1Mom1[4:7,:]-S10_vort_int.P1S1Mom1[4:7,:])*(S10_vort_int.P2VMom1[4:7,:]-S10_vort_int.P1VMom1[4:7,:])/B0,axis=0),S10.y/np.mean(S10.z_enc[4:7]),c=blues(0.7),ls='-.')
ax1.plot(np.mean(S15_vort_int.int2[4:7,:]*S15_vort_int.int1[4:7,:]*(S15_vort_int.P2S1Mom1[4:7,:]-S15_vort_int.P1S1Mom1[4:7,:])*(S15_vort_int.P2VMom1[4:7,:]-S15_vort_int.P1VMom1[4:7,:])/B0,axis=0),S15.y/np.mean(S15.z_enc[4:7]),c=blues(0.8),ls='-.')
ax1.plot(np.mean(S20_vort_int_1.int2[4:,:]*S20_vort_int_1.int1[4:,:]*(S20_vort_int_1.P2S1Mom1[4:,:]-S20_vort_int_1.P1S1Mom1[4:,:])*(S20_vort_int_1.P2VMom1[4:,:]-S20_vort_int_1.P1VMom1[4:,:])/B0,axis=0),S20_1.y/np.mean(S20_1.z_enc[4:]),c=blues(0.9),ls='-.')
ax1.plot(np.mean(S25_vort_int.int2[4:7,:]*S25_vort_int.int1[4:7,:]*(S25_vort_int.P2S1Mom1[4:7,:]-S25_vort_int.P1S1Mom1[4:7,:])*(S25_vort_int.P2VMom1[4:7,:]-S25_vort_int.P1VMom1[4:7,:])/B0,axis=0),S25.y/np.mean(S25.z_enc[4:7]),c=blues(0.5),ls='-.')
ax1.plot(np.mean(S0.Rsv[4:7,:]/B0,axis=0),S0.y/np.mean(S0.z_enc[4:7]),c=blues(0.5),ls=':')
ax1.plot(np.mean(S05.Rsv[4:7,:]/B0,axis=0),S05.y/np.mean(S05.z_enc[4:7]),c=blues(0.6),ls=':')
ax1.plot(np.mean(S10.Rsv[4:7,:]/B0,axis=0),S10.y/np.mean(S10.z_enc[4:7]),c=blues(0.7),ls=':')
ax1.plot(np.mean(S15.Rsv[4:7,:]/B0,axis=0),S15.y/np.mean(S15.z_enc[4:7]),c=blues(0.8),ls=':')
ax1.plot(np.mean(S20_1.Rsv[4:,:]/B0,axis=0),S20_1.y/np.mean(S20_1.z_enc[4:]),c=blues(0.9),ls=':')
ax1.plot(np.mean(S25.Rsv[4:7,:]/B0,axis=0),S25.y/np.mean(S25.z_enc[4:7]),c=blues(1.0),ls=':')
ax3.plot(np.mean(S0_vort_int.P2v1[4:7,:]-S0_vort_int.P2S1Mom1[4:7,:]*S0_vort_int.P2VMom1[4:7,:],axis=0)/B0,S0.y/np.mean(S0.z_enc[4:7]),c=blues(0.5))
ax3.plot(np.mean(S05_vort_int.P2v1[4:7,:]-S05_vort_int.P2S1Mom1[4:7,:]*S05_vort_int.P2VMom1[4:7,:],axis=0)/B0,S05.y/np.mean(S05.z_enc[4:7]),c=blues(0.6))
ax3.plot(np.mean(S10_vort_int.P2v1[4:7,:]-S10_vort_int.P2S1Mom1[4:7,:]*S10_vort_int.P2VMom1[4:7,:],axis=0)/B0,S10.y/np.mean(S10.z_enc[4:7]),c=blues(0.7))
ax3.plot(np.mean(S15_vort_int.P2v1[4:7,:]-S15_vort_int.P2S1Mom1[4:7,:]*S15_vort_int.P2VMom1[4:7,:],axis=0)/B0,S15.y/np.mean(S15.z_enc[4:7]),c=blues(0.8))
ax3.plot(np.mean(S20_vort_int_1.P2v1[4:,:]-S20_vort_int_1.P2S1Mom1[4:,:]*S20_vort_int_1.P2VMom1[4:,:],axis=0)/B0,S20_1.y/np.mean(S20_1.z_enc[4:]),c=blues(0.9))
ax3.plot(np.mean(S25_vort_int.P2v1[4:7,:]-S25_vort_int.P2S1Mom1[4:7,:]*S25_vort_int.P2VMom1[4:7,:],axis=0)/B0,S25.y/np.mean(S25.z_enc[4:7]),c=blues(1.0))
ax4.plot(S0.z_enc[1:-1]/L0,-runningmean(np.array(S0_vort_p2_v1_zif)-np.array(S0_vort_p2_s1_mean_zif)*np.array(S0_vort_p2_w_mean_zif),1)/B0,c=blues(0.5),label=r'$Fr_0=0$')
ax4.plot(S05.z_enc[1:-1]/L0,-runningmean(np.array(S05_vort_p2_v1_zif)-np.array(S05_vort_p2_s1_mean_zif)*np.array(S05_vort_p2_w_mean_zif),1)/B0,c=blues(0.6),label=r'$Fr_0=5$')
ax4.plot(S10.z_enc[1:-1]/L0,-runningmean(np.array(S10_vort_p2_v1_zif)-np.array(S10_vort_p2_s1_mean_zif)*np.array(S10_vort_p2_w_mean_zif),1)/B0,c=blues(0.7),label=r'$Fr_0=10$')
ax4.plot(S15.z_enc[1:-1]/L0,-runningmean(np.array(S15_vort_p2_v1_zif)-np.array(S15_vort_p2_s1_mean_zif)*np.array(S15_vort_p2_w_mean_zif),1)/B0,c=blues(0.8),label=r'$Fr_0=15$')
ax4.plot(time[1:-1],-runningmean(np.array(S20_vort_p2_v1_zif)-np.array(S20_vort_p2_s1_mean_zif)*np.array(S20_vort_p2_w_mean_zif),1)/B0,c=blues(0.9),label=r'$Fr_0=20$')
ax4.plot(S25.z_enc[1:-1]/L0,-runningmean(np.array(S25_vort_p2_v1_zif)-np.array(S25_vort_p2_s1_mean_zif)*np.array(S25_vort_p2_w_mean_zif),1)/B0,c=blues(1.0),label=r'$Fr_0=25$')
ax1.set_xlabel(r'$f /B_0$')
ax1.set_ylabel(r'$z/z_{enc}$')
ax1.set_title('(a)',fontsize=24,loc='left')
ax3.set_xlabel(r'$\langle b^\prime w^\prime\rangle_T/B_0$')
ax3.set_ylabel(r'$z/z_{enc}$')
ax3.set_title(r'(b)',fontsize=24,loc='left')
ax4.set_xlabel(r'$z_{enc}/L_0$')
ax4.set_ylabel(r'$-(\langle b^\prime w^\prime \rangle_T)_{z_{i,f}}/B_0$')
ax4.set_title(r'(c)',fontsize=24,loc='left')
ax4.legend(loc='upper left',fontsize=18,handlelength=1,borderaxespad=0.1,ncol=2,columnspacing=1)
