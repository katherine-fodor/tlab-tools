...
ax1.plot(S20.y/np.mean(S20.z_enc[4:7]),S20.y/np.mean(S20.z_enc[4:7]),'k--',label=r'$N_0^2z$')
...
black_solid = mlines.Line2D([],[],c=blues(0.7),label='Turbulent')
black_dashed = mlines.Line2D([],[],c=blues(0.7),ls='--',label='Non- \n turbulent')
...
ax2.legend(handles=[black_solid,black_dashed],loc='center right',fontsize=18,borderaxespad=0.1,handlelength=1,labelspacing=0.3)
plt.tight_layout()
plt.savefig(opath+'s1_w_mean_height_S20_S0_vort.pdf',bbox_inches='tight')
plt.show()
...
ax1.legend(loc='best',fontsize=20)
plt.tight_layout()
plt.savefig(opath+'s1_w_rms_height_time_S20_S0_vort_zif.pdf',bbox_inches='tight')
plt.show()
...
ax2.legend(loc='best',fontsize=20)
plt.tight_layout()
plt.savefig(opath+'rho_bw_turb_height_time_S20_S0.pdf',bbox_inches='tight')
plt.show()
...
plt.plot(np.mean(NS42_1.Rsv[-4:-1,:]/B0,axis=0),NS42_1.y/np.mean(NS42_1.z_enc[-4:-1]),c=greys(0.5))
...
plt.plot(np.mean(S20.Rsv[4:7,:]/B0,axis=0),S20.y/np.mean(S20.z_enc[4:7]),c=greys(0.9))
plt.axhline(np.mean(NS42_1.z_if[-4:-1]/NS42_1.z_enc[-4:-1]),0,0.05,c=blues(0.5))
plt.axhline(np.mean(S20.z_if[4:7]/S20.z_enc[4:7]),0,0.05,c=blues(0.9))
plt.xlabel(r'$f /B_0$')
plt.ylabel(r'$z/z_\mathrm{enc}$')
plt.legend(loc='best',fontsize=20,handlelength=1)
plt.tight_layout()
plt.savefig(opath+'s1_vflux_contributions_S20_S0_total.pdf')
plt.show()
...
ax2.grid(True,linewidth=1.5)
ax3.grid(True,linewidth=1.5)
ax1.tick_params(bottom=False,left=False,labelsize=24)
ax2.tick_params(bottom=False,left=False,labelsize=24)
ax3.tick_params(bottom=False,left=False,labelsize=24)
...
ax3.set_ylim(0,0.4)
ax3.set_xlim(15,30)
ax1.plot(np.mean(NS42_vort_int_1.int2[-4:-1,:]*(NS42_vort_int_1.P2v1[-4:-1,:]-NS42_vort_int_1.P2S1Mom1[-4:-1,:]*NS42_vort_int_1.P2VMom1[-4:-1,:])/B0,axis=0),NS42_1.y/np.mean(NS42_1.z_enc[-4:-1]),c=blues(0.5),label=r'$Fr_0=0$')
ax1.plot(np.mean(S20_vort_int.int2[4:7,:]*(S20_vort_int.P2v1[4:7,:]-S20_vort_int.P2S1Mom1[4:7,:]*S20_vort_int.P2VMom1[4:7,:])/B0,axis=0),S20.y/np.mean(S20.z_enc[4:7]),c=blues(0.9),label=r'$Fr_0=20$')
...
ax1.plot(np.mean(NS42_1.Rsv[-4:-1,:]/B0,axis=0),NS42_1.y/np.mean(NS42_1.z_enc[-4:-1]),c=greys(0.5))
ax1.plot(np.mean(S20.Rsv[4:7,:]/B0,axis=0),S20.y/np.mean(S20.z_enc[4:7]),c=greys(0.9))
ax2.plot(np.mean(NS42_vort_int_1.P2v1[-4:-1,:]-NS42_vort_int_1.P2S1Mom1[-4:-1,:]*NS42_vort_int_1.P2VMom1[-4:-1,:],axis=0)/B0,NS42_1.y/np.mean(NS42_1.z_enc[-4:-1]),c=blues(0.5))
ax2.plot(np.mean(S20_vort_int.P2v1[4:7,:]-S20_vort_int.P2S1Mom1[4:7,:]*S20_vort_int.P2VMom1[4:7,:],axis=0)/B0,S20.y/np.mean(S20.z_enc[4:7]),c=blues(0.9))
ax3.plot(time[1:-1],-runningmean(np.array(NS42_vort_p2_v1_zif)-np.array(NS42_vort_p2_s1_mean_zif)*np.array(NS42_vort_p2_w_mean_zif),1)/B0,c=blues(0.5),label=r'$Fr_0=0$')
ax3.plot(S20.z_enc[1:-1]/L0,-runningmean(np.array(S20_vort_p2_v1_zif)-np.array(S20_vort_p2_s1_mean_zif)*np.array(S20_vort_p2_w_mean_zif),1)/B0,c=blues(0.9),label=r'$Fr_0=20$')
ax1.axhline(np.mean(NS42_1.z_if[-4:-1]/NS42_1.z_enc[-4:-1]),0,0.05,c=blues(0.5))
ax1.axhline(np.mean(S20.z_if[4:7]/S20.z_enc[4:7]),0,0.05,c=blues(0.9))
ax2.axhline(np.mean(NS42_1.z_if[-4:-1]/NS42_1.z_enc[-4:-1]),0,0.05,c=blues(0.5))
ax2.axhline(np.mean(S20.z_if[4:7]/S20.z_enc[4:7]),0,0.05,c=blues(0.9))
ax1.set_xlabel(r'$f /B_0$',fontsize=24)
ax1.set_ylabel(r'$z/z_\mathrm{enc}$',fontsize=24)
ax1.set_title('(a)',fontsize=24,loc='left')
ax2.set_xlabel(r'$\langle b^\prime w^\prime\rangle_\mathrm{T}/B_0$',fontsize=24)
ax2.set_ylabel(r'$z/z_\mathrm{enc}$',fontsize=24)
ax2.set_title(r'(b)',fontsize=24,loc='left')
ax3.set_xlabel(r'$z_\mathrm{enc}/L_0$',fontsize=24)
ax3.set_ylabel(r'$-(\langle b^\prime w^\prime \rangle_\mathrm{T})_{z_{i,f}}/B_0$',fontsize=24)
ax3.set_title(r'(c)',fontsize=24,loc='left')
ax3.legend(loc='best',fontsize=24)
plt.tight_layout()
plt.savefig(opath+'s1_vflux_contributions_turb_height_time_S20_S0_vort.pdf',bbox_inches='tight')
plt.show()
...
plt.axhline(np.mean(NS42_1.z_if[-4:-1]/NS42_1.z_enc[-4:-1]),0,0.05,c=oranges(0.5))
plt.axhline(np.mean(S20.z_if[4:7]/S20.z_enc[4:7]),0,0.05,c=oranges(0.9))
plt.xlabel(r'$f /B_0$')
plt.ylabel(r'$z/z_\mathrm{enc}$')
...
ax1.set_ylim(1,1.4)
ax2.set_ylim(1,1.4)
ax1.plot(np.mean(NS42_vort_int_1.P2S1Mom1[-5:,:],axis=0)/np.mean(N**2*NS42_1.z_enc[-5:]),NS42_1.y/np.mean(NS42_1.z_enc[-5:]),c=blues(0.5),label=r'$Fr_0=0$')
ax1.plot(np.mean(S20_vort_int.P2S1Mom1[3:8,:],axis=0)/np.mean(N**2*S20.z_enc[3:8]),S20.y/np.mean(S20.z_enc[3:8]),c=blues(0.9),label=r'$Fr_0=20$')
ax1.plot(np.mean(NS42_vort_int_1.P1S1Mom1[-5:,:],axis=0)/np.mean(N**2*NS42_1.z_enc[-5:]),NS42_1.y/np.mean(NS42_1.z_enc[-5:]),c=blues(0.5),ls='--')
ax1.plot(np.mean(S20_vort_int.P1S1Mom1[3:8,:],axis=0)/np.mean(N**2*S20.z_enc[3:8]),S20.y/np.mean(S20.z_enc[3:8]),c=blues(0.9),ls='--')
ax1.plot(S20.y/np.mean(S20.z_enc[3:8]),S20.y/np.mean(S20.z_enc[3:8]),'k--',label=r'$N_0^2z$')
ax2.plot(np.mean(NS42_vort_int_1.P2VMom1[-5:,:],axis=0)/(np.mean(NS42_1.z_enc[-5:])*B0)**(1./3.),NS42_1.y/np.mean(NS42_1.z_enc[-5:]),c=blues(0.5),label=r'$Fr_0=0$')
ax2.plot(np.mean(S20_vort_int.P2VMom1[3:8,:],axis=0)/(np.mean(S20.z_enc[3:8])*B0)**(1./3.),S20.y/np.mean(S20.z_enc[3:8]),c=blues(0.9),label=r'$Fr_0=20$')
ax2.plot(np.mean(NS42_vort_int_1.P1VMom1[-5:,:],axis=0)/(np.mean(NS42_1.z_enc[-5:])*B0)**(1./3.),NS42_1.y/np.mean(NS42_1.z_enc[-5:]),c=blues(0.5),ls='--')
ax2.plot(np.mean(S20_vort_int.P1VMom1[3:8,:],axis=0)/(np.mean(S20.z_enc[3:8])*B0)**(1./3.),S20.y/np.mean(S20.z_enc[3:8]),c=blues(0.9),ls='--')
#ax2.plot(np.mean(S20_vort_int.int2[3:8,]*S20_vort_int.P2VMom1[3:8,:],axis=0)+np.mean(S20_vort_int.int1[3:8,]*S20_vort_int.P1VMom1[3:8,:],axis=0),S20.y/np.mean(S20.z_enc[3:8]),'k')
ax1.axhline(np.mean(NS42_1.z_if[-5:]/NS42_1.z_enc[-5:]),0,0.05,c=blues(0.5))
ax1.axhline(np.mean(S20.z_if[3:8]/S20.z_enc[3:8]),0,0.05,c=blues(0.9))
ax2.axhline(np.mean(NS42_1.z_if[-5:]/NS42_1.z_enc[-5:]),0,0.05,c=blues(0.5))
ax2.axhline(np.mean(S20.z_if[3:8]/S20.z_enc[3:8]),0,0.05,c=blues(0.9))
ax1.set_xlabel(r'$\langle b \rangle / b_\mathrm{enc}$')
ax1.set_ylabel(r'$z/z_\mathrm{enc}$')
ax1.set_title(r'(a)',fontsize=20,loc='left')
ax2.set_xlabel(r'$\langle w \rangle / w_*$')
ax2.set_ylabel(r'$z/z_\mathrm{enc}$')
ax2.set_title(r'(b)',fontsize=20,loc='left')
ax1.legend(loc='best',fontsize=20,handlelength=1.2)
plt.tight_layout()
