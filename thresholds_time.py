...
ax1.axhline(np.mean(NS25.z_ig/NS25.z_enc),0,0.05,color='k',linewidth=2)
ax1.axhline(np.mean(NS25.z_if/NS25.z_enc),0,0.05,color='k',linewidth=2)
...
ax1.axvline(-1.5,0,0.05,color='k',linewidth=2)
ax1.axvline(0.5,0,0.05,color='k',linewidth=2)
ax2.axvline(-1.5,0,0.05,color='k',linewidth=2)
ax2.axvline(0.5,0,0.05,color='k',linewidth=2)
plt.tight_layout(rect=[0,0.15,1,1],w_pad=2)
