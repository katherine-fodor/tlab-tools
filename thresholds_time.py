...
ax1.set_xlim(-5,1)
ax1.set_ylim(0,0.3)
ax1.plot(np.log10(pvthresholds/(cb*ceps*N**6*42**2*(np.mean(NS42.z_enc)/L0)**(-4./3.))),-pv_nonturb_s1_flux_zif_NS42_timmean/B0,c=oranges(0.5),label=r'$Fr_0=0$')
ax1.plot(np.log10(pvthresholds/(cb*ceps*N**6*42**2*(np.mean(S20.z_enc)/L0)**(-4./3.))),-pv_nonturb_s1_flux_zif_S20_timmean/B0,c=oranges(0.9),label=r'$Fr_0=20$')
ax2.plot(np.log10(pvthresholds/(cb*ceps*N**6*42**2*(np.mean(NS42.z_enc)/L0)**(-4./3.))),-pv_turb_s1_flux_zif_NS42_timmean/B0,c=oranges(0.5),label=r'$Fr_0=0$')
ax2.plot(np.log10(pvthresholds/(cb*ceps*N**6*42**2*(np.mean(S20.z_enc)/L0)**(-4./3.))),-pv_turb_s1_flux_zif_S20_timmean/B0,c=oranges(0.9),label=r'$Fr_0=20$')
...
ax1.axvline(-1.99,0,NS42.y[-1]/np.mean(NS42.z_enc),color=oranges(0.5),linestyle='--')
ax2.axvline(-1.99,0,NS42.y[-1]/np.mean(NS42.z_enc),color=oranges(0.5),linestyle='--')
ax1.axvline(-2.647,0,S20.y[-1]/np.mean(S20.z_enc),color=oranges(0.9),linestyle='--')
ax2.axvline(-2.647,0,S20.y[-1]/np.mean(S20.z_enc),color=oranges(0.9),linestyle='--')
...
plt.tight_layout()
plt.savefig(opath_PV+'s1_vflux_zif_cond_threshold_S20_S0_pv_timmean.pdf')
plt.show()
