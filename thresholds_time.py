...
cs2 = ax2.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_117)),NS117.y/np.mean(NS117.z_enc),vort_turb_area_fracs_NS117_timmean,cmap='viridis',levels=np.arange(0,1.1,0.1))
cs1 = ax1.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_25)),NS25.y/np.mean(NS25.z_enc),vort_turb_area_fracs_NS25_timmean,cmap='viridis',levels=np.arange(0,1.1,0.1))
cbar_ax = f.add_axes([0.35,0.15,0.5,0.02])
...
ax2.set_title('(b) $Re_0=117$',loc='left',fontsize=24)
ax1.set_title('(a) $Re_0=25$',loc='left',fontsize=24)
ax2.axvline(-0.62,0,NS117.y[-1]/np.mean(NS117.z_enc),color='k',linestyle='--')
ax1.axvline(-0.5,0,NS117.y[-1]/np.mean(NS117.z_enc),color='k',linestyle='--')
plt.tight_layout(rect=[0,0.15,1,1],w_pad=2)
...
ax1.set_ylim(1,1.5)
cs1 = ax1.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),NS42.y/np.mean(NS42.z_enc),vort_turb_area_fracs_NS42_timmean,cmap='viridis',levels=np.arange(0,1.1,0.1))
cs2 = ax2.contourf(np.log10(vort_thresholds**2/(ceps*B0/nu_42)),S20.y/np.mean(S20.z_enc),vort_turb_area_fracs_S20_timmean,cmap='viridis',levels=np.arange(0,1.1,0.1))
ax1.axhline(np.mean(NS42.z_ig)/np.mean(NS42.z_enc),0,0.05,color='C1',linewidth=2)
ax1.axhline(np.mean(NS42.z_if)/np.mean(NS42.z_enc),0,0.05,color='C1',linewidth=2)
ax2.axhline(np.mean(S20.z_ig)/np.mean(S20.z_enc),0,0.05,color='C1',linewidth=2)
ax2.axhline(np.mean(S20.z_if)/np.mean(S20.z_enc),0,0.05,color='C1',linewidth=2)
cbar_ax = f.add_axes([0.35,0.15,0.5,0.02])
cbar = f.colorbar(cs1,cax=cbar_ax,orientation='horizontal')
cbar.ax.set_xlabel(r'$a_\mathrm{T}$')
ax1.set_ylabel(r'$z/z_\mathrm{enc}$')
...
#ax1.set_xlabel(r'$\log_{10}(\omega_\mathrm{th}^2/\omega_0^2)$')
ax2.set_xlabel(r'$\log_{10}(\omega_\mathrm{th}^2/\omega_0^2)$')
ax1.set_title('(a) $Fr_0=0$',loc='left',fontsize=24)
ax2.set_title('(b) $Fr_0=20$',loc='left',fontsize=24)
...
ax1.axvline(-1.5,0,0.05,color='C1',linewidth=2)
ax1.axvline(0.5,0,0.05,color='C1',linewidth=2)
ax2.axvline(-1.5,0,0.05,color='C1',linewidth=2)
ax2.axvline(0.5,0,0.05,color='C1',linewidth=2)
plt.tight_layout(rect=[0,0.15,1,1],w_pad=2)
...
ax5.set_xlim(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)))
ax1.set_ylim(0,0.3)
ax3.set_ylim(0,2)
ax5.set_ylim(0,0.6)
...
ax5.set_title('(e)',loc='left',fontsize=24)
ax6.set_title('(f)',loc='left',fontsize=24)
ax1.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax1.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax2.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax2.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax3.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax3.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax4.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax4.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax5.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax5.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax6.axvspan(np.log10(vort_thresholds[0]**2/(ceps*B0/nu_42)),-1.5,facecolor='grey',alpha=0.5)
ax6.axvspan(0.5,np.log10(vort_thresholds[-1]**2/(ceps*B0/nu_42)),facecolor='grey',alpha=0.5)
ax6.legend(loc='lower left',fontsize=24,handlelength=1,borderaxespad=0.2)
plt.tight_layout()
