...
maxvort_S10 = np.log10(np.exp(maxvort_S10)/(ceps*B0/nu_15))
...
ax1.plot(S10.z_enc[1:-1]/L_0,y_maxit_vort_S10,c=blues(0.6))
ax1.plot(S15.z_enc[1:-1]/L_0,y_maxit_vort_S15,c=blues(0.8))
...
ax1.plot(S15.z_enc[1:-1]/L_0,runningmean(S15.z_ig/S15.z_enc,1),c=blues(0.8),ls=':',label=r'$z_{i,g}/z_\mathrm{enc}$')
ax1.plot(S10.z_enc[1:-1]/L_0,runningmean(S10.z_if/S10.z_enc,1),c=blues(0.6),ls=':',label=r'$z_{i,f}/z_\mathrm{enc}$')
...
ax2.plot(S10.z_enc[1:-1]/L_0,maxvort_it_S10,c=blues(0.6),label=r'$Fr_0=10$')
ax2.plot(S15.z_enc[1:-1]/L_0,maxvort_it_S15,c=blues(0.8),label=r'$Fr_0=15$')
...
ax1.legend(loc='best',fontsize=24,handlelength=1,borderaxespad=0.2)#,ncol=2,columnspacing=0.5,handletextpad=0.4)
ax2.legend(loc='best',fontsize=24,handlelength=1)#,ncol=2,columnspacing=0.5,handletextpad=0.4)
plt.tight_layout(h_pad=2)
plt.savefig(opath+'pdfs_saddle_point_Re025.pdf',bbox_inches='tight')
plt.show()
